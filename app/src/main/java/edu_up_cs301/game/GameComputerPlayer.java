			...
			if (data instanceof GameInfo) { // ignore non GameInfo objects
				...
				if (game == null) {
					...
					if (myInfo instanceof BindGameInfo) {
						...
						game.sendAction(new MyNameIsAction(edu_up_cs301.game.GameComputerPlayer.this, name));
					}
				}
					...
					if (myInfo instanceof StartGameInfo) {
						...
						game.sendAction(new ReadyAction(edu_up_cs301.game.GameComputerPlayer.this));
					}
				}
					...
					game.sendAction(new GameOverAckAction(edu_up_cs301.game.GameComputerPlayer.this));
