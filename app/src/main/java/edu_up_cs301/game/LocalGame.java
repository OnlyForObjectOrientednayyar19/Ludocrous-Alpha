...
import edu_up_cs301.game.actionMsg.TimerAction;
...
public abstract class LocalGame implements Game, Tickable {
	...
	public void start(GamePlayer[] players) {
		...
		synchronized(this) {
			...
			Runnable runnable = new Runnable() {
				public void run() {
					Looper.prepare();
					myHandler = new MyHandler(edu_up_cs301.game.LocalGame.this);
					Looper.loop();
				}
			};
	...
	private static class MyHandler extends Handler {
		// the game
		private edu_up_cs301.game.LocalGame game;
		
		// constructor; parameter is expected to be this game
		public MyHandler(edu_up_cs301.game.LocalGame game) {
			this.game = game;
		}
