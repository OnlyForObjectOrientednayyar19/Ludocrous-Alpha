...
import edu_up_cs301.game.util.NetworkObjectPasser;
...
public class ProxyGame implements Game {
     ...
     * @return
     */
    public static edu_up_cs301.game.ProxyGame create(int portNum, String ipCode) {
    	// create the game object
    	edu_up_cs301.game.ProxyGame rtnVal = new edu_up_cs301.game.ProxyGame(portNum, ipCode);
        	...
        	public void onReceiveObject(Object obj) {
        		...
        		try {
        			...
        			if (b) {
        				...
        				gs.setGame(edu_up_cs301.game.ProxyGame.this);
        				synchronized(this) {
        					if (player == null) {
